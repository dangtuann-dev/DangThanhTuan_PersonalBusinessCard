...
const buttons: CTAButton[] = [
  ...
  },
  {
    name: "GitHub",
    icon: GitHubIcon,
    href: "https://github.com/dangtuann-dev",
    isExternal: true,
    ariaLabel: "Follow Dang Thanh Tuan on GitHub",
    tooltip: "GitHub",
  },
  {
    name: "Telegram",
    icon: TelegramIcon,
    href: "https://t.me/dangtuandev",
    isExternal: true,
    ariaLabel: "Chat with Dang Thanh Tuan on Telegram",
    tooltip: "Telegram",
  },
  {
    name: "TikTok",
    icon: TikTokIcon,
    href: "https://www.tiktok.com/@tunatheavanti",
    isExternal: true,
    ariaLabel: "Follow Dang Thanh Tuan on TikTok",
    tooltip: "TikTok",
  },
  {
    name: "YouTube",
    icon: YouTubeIcon,
    href: "https://www.youtube.com/@dangtuandev",
    isExternal: true,
    ariaLabel: "Subscribe to Dang Thanh Tuan on YouTube",
    tooltip: "YouTube",
  },
  {
    name: "Threads",
    icon: ThreadsIcon,
    href: "https://www.threads.net/@tunatheavanti",
    isExternal: true,
    ariaLabel: "Follow Dang Thanh Tuan on Threads",
    tooltip: "Threads",
  },
  {
    name: "X",
    icon: XIcon,
    href: "https://x.com/dangtuandev",
    isExternal: true,
    ariaLabel: "Follow Dang Thanh Tuan on X",
    tooltip: "X",
  },
];
